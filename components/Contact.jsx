...
const Contact = () => {
  ...
  return (
    <motion.div
      ...
      id='contact'
      className='w-full min-h-screen flex items-center justify-center px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'
    >
