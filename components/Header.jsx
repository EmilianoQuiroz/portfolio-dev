  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <motion.h3
        ...
        Hi! I'm Santiago Quiroz <Image src={assets.hand_icon} alt='hand-icon' className='w-6' />
      </motion.h3>
      <motion.h1
      ...
      >
        Web and mobile developer based in Portugal.
      </motion.h1>
      <motion.p
        initial={{opacity: 0}}
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-8'>
        ...
        >
        download CV <Image src={assets.download_icon} alt='download' className='w-4' />
        </motion.a>
      </div>
    </div>
  )
